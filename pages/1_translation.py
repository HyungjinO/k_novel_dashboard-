...
# --- 파이(도넛) 차트 함수 ---
def plot_genre_pie(data, title, kor_map, emoji_map, color_map, showlegend=True):
    ...
    fig.update_layout(
        ...
        legend=dict(title=title, yanchor="top", y=1, xanchor="left", x=1.05)
    )
    fig.update_traces(
        textposition='inside',
